...
import com.gumeng.uniSearch.mapper.PostFavourMapper;
import com.gumeng.uniSearch.mapper.PostMapper;
import com.gumeng.uniSearch.mapper.PostThumbMapper;
...
import com.gumeng.uniSearch.constant.CommonConstant;
import com.gumeng.uniSearch.exception.BusinessException;
import com.gumeng.uniSearch.exception.ThrowUtils;
import com.gumeng.uniSearch.model.dto.post.PostEsDTO;
import com.gumeng.uniSearch.model.dto.post.PostEsHighlightData;
import com.gumeng.uniSearch.model.dto.post.PostQueryRequest;
import com.gumeng.uniSearch.model.entity.PostFavour;
import com.gumeng.uniSearch.model.entity.PostThumb;
import com.gumeng.uniSearch.model.entity.User;
import com.gumeng.uniSearch.service.PostService;
import com.gumeng.uniSearch.service.UserService;
import com.gumeng.uniSearch.utils.SqlUtils;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        // 必须包含所有标签
        if (com.baomidou.mybatisplus.core.toolkit.CollectionUtils.isNotEmpty(tagList)) {
            for (String tag : tagList) {
                boolQueryBuilder.filter(QueryBuilders.termQuery("tags", tag));
            }
        }
        // 包含任何一个标签即可
        if (com.baomidou.mybatisplus.core.toolkit.CollectionUtils.isNotEmpty(orTagList)) {
        ...
        highlightBuilder.field("*").preTags("<font color='#2788ff'>")
